...
GRANT_TOKEN = "1000.4628256772abf9e202104dabc36fafbb.7ff8563d715f9df94206598e45a4f82c"
...
print("--- DEFINITIVE SILENT SEEDER ---")
tokens = get_tokens()
if "error" in tokens:
...
for rec in records:
    ...
    try:
        # Note: metadata scan suggests link names are lowercase
        res = requests.post(url, headers=headers, json=rec["data"], timeout=30)
